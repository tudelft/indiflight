...
LAPACK_FILTER_OUT += $(LAPACK_DIR)/F2CLIBS/libf2c/backspac.c
...
LAPACK_SOURCE_OPTIM += $(filter-out $(LAPACK_FILTER_OUT), $(wildcard $(LAPACK_DIR)/SRC/*.c))
LAPACK_SOURCE_NO_OPTIM += $(filter-out $(LAPACK_FILTER_OUT), $(wildcard $(LAPACK_DIR)/F2CLIBS/libf2c/*.c))
LAPACK_SOURCE_NO_OPTIM += $(LAPACK_DIR)/INSTALL/dlamch.c
LAPACK_SOURCE_NO_OPTIM += $(LAPACK_DIR)/INSTALL/dsecnd.c
LAPACK_SOURCE_NO_OPTIM += $(LAPACK_DIR)/INSTALL/second.c
LAPACK_SOURCE_NO_OPTIM += $(LAPACK_DIR)/INSTALL/slamch.c
LAPACK_SOURCE = $(LAPACK_SOURCE_OPTIM)
LAPACK_SOURCE += $(LAPACK_SOURCE_NO_OPTIM)
SRC += $(LAPACK_SOURCE)
