...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_POSITION_HORIZONTAL_I,           VAR_UINT8 | PROFILE_POSITION_VALUE, .config.minmaxUnsigned = { 2, 1 << 7 }, PG_POSITION_PROFILE, offsetof(positionProfile_t, horz_i) },
    ...
    { PARAM_NAME_POSITION_MAX_HORIZONTAL_SPEED,   VAR_UINT16 | PROFILE_POSITION_VALUE, .config.minmaxUnsigned = { 50, 1 << 15 }, PG_POSITION_PROFILE, offsetof(positionProfile_t, horz_max_v) },
    ...
    { PARAM_NAME_POSITION_YAW_P,                  VAR_UINT8 | PROFILE_POSITION_VALUE, .config.minmaxUnsigned = { 5, 1 << 7 }, PG_POSITION_PROFILE, offsetof(positionProfile_t, yaw_p) },
    ...
    { PARAM_NAME_POSITION_WEATHERVANE_MIN_V,      VAR_UINT16 | PROFILE_POSITION_VALUE, .config.minmaxUnsigned = { 25, 1 << 15 }, PG_POSITION_PROFILE, offsetof(positionProfile_t, weathervane_min_v) },
