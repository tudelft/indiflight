...
void processKey(uint8_t key) {
    ...
    switch (key) {
        ...
        case KEY_2: incrementSpeedTrajectoryTracker(-0.1f); break;
        case KEY_3: incrementSpeedTrajectoryTracker(+0.1f); break;
        ...
        case KEY_V: tt_heading_mode = TT_LOOK_ALONG_VELOCITY; break;
